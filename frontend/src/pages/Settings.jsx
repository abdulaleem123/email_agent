...
const NUMBERS = [
  ...
  ['followup_after_hours', 'Follow up after silence (hours)', '24 = wait 1 day between follow-ups'],
  ['max_followups', 'Max follow-ups per lead', 'set to 3 — final email closes the loop'],
