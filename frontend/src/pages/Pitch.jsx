...
//     show('Building pitch from research…')
//     try {
...
//   // Call-pickup transcript: agent notes what actually happened on the call,
//   // and the transcript is generated to match that exact outcome.
...
//             (company, person, website, country — DuckDuckGo research, free) and role-plays
...
//               {/* CALL PICKUP: if client picked up — paste what happened, get a transcript */}
...
//                   Write what happened in plain words — their mood, what they said, any objections, outcome (booked / not interested / call later). The transcript will match your notes exactly.
//                 </div>
//                 <textarea
//                   rows={3}
