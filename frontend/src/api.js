// /**
//  * Chatversio Email CRM — frontend API client
//  * Pure JS only (no JSX).
//  */
...
//     request('/api/pitch/generate', { method: 'POST', body: JSON.stringify(payload) }),
//   generatePickupTranscript: (payload) =>
//     request('/api/pitch/pickup', { method: 'POST', body: JSON.stringify(payload) }),
//   askPitch: (payload) =>
//     request('/api/pitch/ask', { method: 'POST', body: JSON.stringify(payload) }),
